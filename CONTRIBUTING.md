...
- No comments unless the _why_ is non-obvious. Don't narrate what well-named code already says.
...
4. Open a pull request against `main`. Describe the _why_ in the PR body, not the _what_ — the diff already shows the _what_.
